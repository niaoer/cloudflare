...
function cloudflare_conf() {
	...
	if ( isset($_POST['submit']) 
        ...
        $messages = array(
                          'new_key_empty' => array('color' => 'aa0', 'text' => __('API Key 已清除')),
                          'new_key_valid' => array('color' => '2d2', 'text' => __('您的 API Key 已验证')),
                          'new_email_empty' => array('color' => 'aa0', 'text' => __('Email 已清除')),
                          'new_email_valid' => array('color' => '2d2', 'text' => __('您的 Email 已验证'))
                          );
